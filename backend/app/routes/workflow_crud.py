"""Core workflow CRUD endpoints: create, list, get, update, delete, bulk-delete."""
...
async def list_workflows(
    ...
    search: Annotated[
        str | None,
        Query(description="Search workflows by name (case-insensitive substring)"),
    ] = None,
    limit: Annotated[
        int,
    ...
    """List workflow definitions with optional tag and search filters."""
    if search:
        return workflow_engine.search_workflows(
            query=search, tag=tag, limit=limit, offset=offset,
        )
...
async def update_workflow(
    ...
    """Update an existing workflow (increments version)."""
